    ...
    <footer className="bg-gray-900 text-white mt-20 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center">
              ...
              <h2 className="ml-2 text-lg font-heading font-bold">Design Deck Challenge</h2>
            </div>
            <p className="text-sm text-gray-400 mt-2">Helping junior designers practice and grow.</p>
          </div>
          ...
          <div className="flex gap-6">
            ...
            <Link href="/">
              <a className="text-gray-400 hover:text-white transition-colors">Resources</a>
            </Link>
            <Link href="/">
        ...
        <div className="border-t border-gray-700 mt-6 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">&copy; {new Date().getFullYear()} Design Deck Challenge. All rights reserved.</p>
